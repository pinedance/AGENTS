...
2. Push as new branch and create a Pull Request
3. Discard this work
...
Wait for 'discard' input. Then, ask one more final confirmation question:
```
Are you absolutely sure you want to delete this branch and worktree? This cannot be undone. (yes/no)
```
Wait for 'yes' input before proceeding.
